                    ...
                    <div className="container">
                        <div className="location">
                            <div className="location-adres">
                                ...
                                <Link>Shahar: <span>Toshkent</span></Link>
                            </div>
                ...
                <div className="main-header">
                    <div className="container">
                        ...
                        <div className="search-header">
                            ...
                            <input type="search" onChange={(e)=>handleSearch(e)} placeholder='Mahsulotlar va turkumlar izlash' />
                        </div>
                        <div className="header-functs">
                            {!loggedIn ? (
                                ...
                                <>
                                    <Link to={"/profile"} className="auth profile">
                                        <img src={assets.profile} alt="profile" />
                                    </Link>
                                    <button onClick={(e) => signOutFunc(e)} className="px-6 py-2 rounded-lg bg-indigo-600 text-white font-semibold 
